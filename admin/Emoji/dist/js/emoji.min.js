...
emojiApp.config(["$sceProvider", function(a) {
        ...
        for (c = 0; c < Config.EmojiCategories.length; c++)
            for (h = Config.EmojiCategorySpritesheetDimens[c][1], b = 0; b < Config.EmojiCategories[c].length; b++) e = Config.Emoji[Config.EmojiCategories[c][b]], d = Config.EmojiCategories[c][b], f = Math.floor(b / h), g = b % h, i[":" + d + ":"] = [c, f, g, ":" + d + ":"], j[d] = e[0];
        ...
        function e(b, e, f) {
            ...
            if ($("#messageDiv").replaceWith(r(b)), q) {
                ...
                $('#messageDiv').bind('keyup', function(event) {
    ...
    function(a, b, c) {
        ...
        k.prototype.setup = function() {
            ...
            var d = b[0],
                ...
                k = -(i * f),
                l = -(i * e),
                m = a.emojiarea.spritesheetDimens[d] ? a.emojiarea.spritesheetDimens[d][1] * i : 0,
                n = a.emojiarea.spritesheetDimens[d] ? a.emojiarea.spritesheetDimens[d][0] * i : 0,
                // n = a.emojiarea.spritesheetDimens[d][0] * i,
                o = "display:inline-block;";

            return o += "width:" + i + "px;", o += "height:" + i + "px;", o += "background:url('lib/img/"+ g +".png') " + k + "px " + l + "px no-repeat;", o += "background-position: center;", '<img src="img/blank.gif" class="img" style="' + o + '" alt="' + j.htmlEntities(g) + '">'
