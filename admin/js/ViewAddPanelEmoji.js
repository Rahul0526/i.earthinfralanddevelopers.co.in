function setEmoji() {
    ...
    var NoOdBanners = $("#bannerCounter").text()
   
    for (var count = 0; count < NoOdBanners; count++) {
        var descriptionID = "#discription_banner1" + count;
        var value = $(descriptionID).text() + "";
        ...
        $(descriptionID).html(replacedStr);
    }
}