...
function populateStates(countryElementId, stateElementId) {
    ...
    document.getElementById("ContentPlaceHolder1_hdfnCountry").value = strUser;
...
function LoadAfter() {
    ...
    var selected_country = document.getElementById('ContentPlaceHolder1_lbCurrentCountry').innerText;
    var currentIndex = '';
    for (var i = 0; i < country_arr.length; i++) {
        //        countryElement.options[countryElement.length] = new Option(country_arr[i], country_arr[i]);
        if (country_arr[i] == selected_country) {
            currentIndex = i;
        }
    }
    e.selectedIndex = currentIndex + 1;
    ...
    var state_arr = s_a[currentIndex + 1].split("|");
    ...
    var selected_State = document.getElementById('ContentPlaceHolder1_lbCurrentState').innerText;
    var currentIndexState = '';
    for (var i = 0; i < state_arr.length; i++) {
        //        countryElement.options[countryElement.length] = new Option(country_arr[i], country_arr[i]);
        if (state_arr[i] == selected_State) {
            currentIndexState = i;
        }
    }
    stateElement.selectedIndex = currentIndexState + 1;
