<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Affiliate_master_page.master"
    AutoEventWireup="true" CodeFile="view_click_report_for_affiliate.aspx.cs" Inherits="admin_view_click_report_for_affiliate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h3>
        Affiliate Report View Click</h3>
    <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                Search By Campaign
                <asp:DropDownList ID="DropDownList1" ForeColor="Black" runat="server" AutoPostBack="True"
            ...
            <div style="max-height: 800px; overflow: scroll">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BackColor="White"
                    Width="100%" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Impressions">
                            <ItemTemplate>
                                <asp:Label ID="banner_type" runat="server" Text='<%#Eval("total_Impression") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
