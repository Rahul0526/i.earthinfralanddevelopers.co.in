...
(function($, window, document) {
  ...
  */
  ...
  EmojiArea.createIcon = function(emoji, menu) {
    ...
    var column = emoji[2];
    var name = emoji[3];
    var filename = $.emojiarea.assetsPath + '/' + name+'.png';
    ...
    style += 'background:url(\'' + filename + '\') center no-repeat;';
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    this.$editor = $('<div>').addClass('emoji-wysiwyg-editor').addClass($($textarea)[0].className).attr('id','messageDiv');
