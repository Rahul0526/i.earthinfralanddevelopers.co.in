			...
			<script type="text/javascript">
				function clicked(item) {
					...
					setTimeout(function () {
						...
						$("#owl-demo").owlCarousel({ autoPlay: false, pagination: false, items: 5, itemsDesktop: [1199, 5], itemsDesktopSmall: [979, 3], itemsTablet: [768, 1.2], itemsTabletSmall: [500, 1.2], itemsMobile: [479, 1.2] }).show();
					}, 100);
				}
			</script>
			<script type="text/javascript">
				...
				function VideoEvent() {
				    ...
				    player.addEventListener('ended',
				        function() {
				            ...
				            var url = "http://i.earthinfralanddevelopers.co.in/Admin/updateVideoView.aspx?camp_id=" +
				                $('#data_campain_id').text() +
				                "&affiliate_id=" +
				                $('#data_affiliatedId').text() +
				                "&sid=" +
				                $('#data_sid2').text() +
				                "&domain_name=" +
				                $('#data_domain_name').text() +
				                "&os_type=" +
				                $('#data_os_type').text() +
				                "&country_name=" +
				                $('#data_country_name').text();
